...
if __name__ == "__main__":
    ...
    sequences_filename = "sequences_transform_Cat3_supplement.yaml"
    ...
    sequences_filename = "sequences_predict_Cat3_supplement.yaml"
    ...
    folder_name="cfg_predict"
    sequences_filename = "sequences_predtrans_limited_Cat3_supplement.yaml"
    gen_cfg("C1-limitlossyG-lossyA-ai",sequences_filename,folder_name)
    gen_cfg("C2-losslessG-lossyA-ai",sequences_filename,folder_name)
