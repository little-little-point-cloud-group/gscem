...
if __name__ == "__main__":
    ...
    sequences_filename1 = "sequences_transform_tw_C1C2.yaml"
    sequences_filename2 = "sequences_transform_tw_C3C4.yaml"
    gen_cfg("C1-limitlossyG-lossyA-ai",sequences_filename1,folder_name)
    gen_cfg("C2-losslessG-lossyA-ai",sequences_filename1,folder_name)
    gen_cfg("C3-losslessG-limitlossyA-ai",sequences_filename2,folder_name)
    gen_cfg("C4-losslessG-losslessA-ai",sequences_filename2,folder_name)
    
    folder_name="cfg_predict"
    sequences_filename = "sequences_predict_tw.yaml"
    ...
    folder_name="cfg_predict"
    sequences_filename = "sequences_predtrans_limited_tw.yaml"
