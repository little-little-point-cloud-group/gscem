...
def gen_cfg(condition, sequences_filename, folder_name):
    ...
    for seq_name in seqs:
        ...
        for r in rps_attr:
            ...
            with open(f'{dir}/encoder.cfg', 'w') as f:
                ordered_yaml_dump(data_r, f, default_flow_style=False)

            # added the multil attribute params
            addMultilAttrParams('{}/encoder.cfg'.format(dir),'{}_multi_attr_params.txt'.format(r))

            # decoder cfg
            data_r = copy.deepcopy(data_dec)
            with open(f'{dir}/decoder.cfg', 'w') as f:
                ordered_yaml_dump(data_r, f, default_flow_style=False)
            ...
            with open(f'{dir}/pcerror.cfg', 'w') as f:
                ordered_yaml_dump(data_r, f, default_flow_style=False)


if __name__ == "__main__":
    folder_name = "cfg_predict_multiple"
